...
messages['HIGH_CARDINALITY'] = u'{varname} has a high cardinality: {0[distinct_count]}  / {0[p_unique]} distinct values  <span class="label label-warning">Warning</span>'
...
messages['p_missing'] = u'{varname} has {0[n_filled]} filled values / {0[p_fill_rate]} fill rate  <span class="label label-default">Missing</span>'
